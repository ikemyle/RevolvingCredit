...
namespace ExpressionBuilder.Generics
{
    ...
    public class FilterStatement<TPropertyType> : IFilterStatement
    {
        ...
        public FilterStatement(string propertyId, IOperation operation, TPropertyType value, TPropertyType value2, 
                                Connector connector, List<SupportedType> supportedTypes)
        {
        ...
        /// </summary>
        public void Validate(List<SupportedType> supportedTypes)
        {
            var helper = new OperationHelper(supportedTypes);
