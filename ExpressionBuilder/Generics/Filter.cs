...
namespace ExpressionBuilder.Generics
{
    ...
    public class Filter<TClass> : IFilter, IXmlSerializable where TClass : class
    {
        ...
        public List<SupportedType> SupportedTypes { get; private set; } = null;
        /// <summary>
        ...
        {
            IFilterStatement statement = new FilterStatement<TPropertyType>(propertyId, operation, value, value2, connector, SupportedTypes);
